        ...
        elements.forEach(element => {
            setTimeout(() => {
                ...
                Object.keys(vars).forEach(prop => {
                    ...
                    if (prop === 'x') {
                        transformValue = `translateX(${vars[prop]}px)`;
                    } else if (prop === 'y') {
                        transformValue = `translateY(${vars[prop]}px)`;
                    } else if (prop === 'scale') {
                        transformValue = `scale(${vars[prop]})`;
                    ...
                    if (transformValue) {
                        ...
                        element.style.transform = currentTransform + ' ' + transformValue;
                    }
                });
